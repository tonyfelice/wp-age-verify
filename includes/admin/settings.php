 ...
 * @since 0.1
 */
function av_settings_callback_bypass_field() { ?>

	<input name="_av_bypass" type="text" id="_av_bypass" value="<?php echo esc_attr( get_option( '_av_bypass', 'bypass' ) ); ?>" /> <?php esc_html_e( 'allows spiders to bypass verification', 'age-verify' ); ?>
...
function av_settings_callback_cookie_duration_field() { ?>
	...
	<input name="_av_cookie_duration" type="number" id="_av_cookie_duration" step="15" size="20" class="small-text" value="<?php echo esc_attr( get_option( '_av_cookie_duration', '720' ) ); ?>" /> <?php esc_html_e( 'minutes', 'age-verify' ); ?>
