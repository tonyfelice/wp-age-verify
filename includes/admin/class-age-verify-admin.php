...
final class Age_Verify_Admin {
	...
	public function register_settings() {
		...
		add_settings_field( '_av_always_verify', __( 'Verify the age of', 'age-verify' ), 'av_settings_callback_always_verify_field', 'age-verify', 'av_settings_general' );
	 	...
	 	// Bypass variable
	 	add_settings_field( '_av_bypass', __( 'Bypass Variable', 'age-verify' ), 'av_settings_callback_bypass_field', 'age-verify', 'av_settings_general' );
	 	register_setting  ( 'age-verify', '_av_bypass', 'intval' );
